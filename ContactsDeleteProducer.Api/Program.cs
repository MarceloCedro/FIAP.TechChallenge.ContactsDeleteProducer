using FIAP.TechChallenge.ContactsDeleteProducer.Api.IoC;
using FIAP.TechChallenge.ContactsDeleteProducer.Api.Logging;
using FIAP.TechChallenge.ContactsDeleteProducer.Api.Middleware;
